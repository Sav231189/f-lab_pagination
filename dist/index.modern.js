...
function Pagination(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, firstPageBtn && /*#__PURE__*/React.createElement("div", {
    onClick: setActivePage,
    className: s.firstPageBtn + ' ' + (activePortion > 1 ? false : s.disabled)
  }, ' ', '«', ' '), prevPageBtn && /*#__PURE__*/React.createElement("div", {
    onClick: setActivePage,
    className: s.prevPageBtn + ' ' + (pageActiveNumber === 1 ? s.disabled : false)
  }, ' ', '‹', ' '), /*#__PURE__*/React.createElement("div", {
    className: s.pagesBox
  }, ellipsisBtn && activePortion > 0 && /*#__PURE__*/React.createElement("div", {
    onClick: setActivePage,
    ...
    return el === pageActiveNumber ? /*#__PURE__*/React.createElement("div", {
      key: el,
  ...
  }), ellipsisBtn && activePortion + 1 < portionCount && /*#__PURE__*/React.createElement("div", {
    onClick: setActivePage,
    className: s.ellipsisLastBtn,
    next: ""
  }, ' ', '...', ' '), showLastPage && ellipsisBtn && activePortion < portionCount - 1 && /*#__PURE__*/React.createElement("div", {
    onClick: setActivePage,
    className: s.pageNumber
  }, paginationItemList.length)), nextPageBtn && /*#__PURE__*/React.createElement("div", {
    onClick: setActivePage,
    className: s.nextPageBtn + ' ' + (pageActiveNumber === paginationItemList.length ? s.disabled : false)
  }, ' ', '›', ' '), lastPageBtn && /*#__PURE__*/React.createElement("div", {
    onClick: setActivePage,
